      ...
      <div className='container'>
        <div className='row justify-content-center'>
          <div className='col-md-8'>
            <h2 className='mb-3'>Politicas de Privacidad</h2>
            <p>
              Este apartado establece los términos en que Focseed usa y protege
              la información que es proporcionada por sus usuarios al momento de
              utilizar su sitio web. Estamos comprometidos con la seguridad de
            ...
            <p>
              Focseed está altamente comprometido para cumplir con el compromiso
